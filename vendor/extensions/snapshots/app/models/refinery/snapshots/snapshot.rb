module Refinery
  module Snapshots
    class Snapshot < Refinery::Core::BaseModel
      ...
      def self.fake_data
        #::Bombora.delete_all
        #::Version.where(item_type: "Bombora").delete_all
        self.delete_all
        #::Version.where(item_type: "Snapshot").delete_all
        ...
        #meta_data = Dts::MetaData.last
        #bombora = ::Bombora.new(run_date: meta_data.created_at, created_at: meta_data.created_at, active: true, description: "Created by DTS")
        #bombora.save(validate: false)
        #
        samples.each do |sample|
          Snapshot.create(sample)
        end
