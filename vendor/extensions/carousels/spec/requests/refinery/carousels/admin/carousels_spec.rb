    ...
    describe "Admin" do
      describe "carousels" do
        ...
        describe "carousels list" do
          before(:each) do
            FactoryGirl.create(:carousel, :name => "UniqueTitleOne")
            FactoryGirl.create(:carousel, :name => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:carousel, :name => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:carousel, :name => "A name") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:carousel, :name => "UniqueTitleOne") }
