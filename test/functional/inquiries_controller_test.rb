...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { address: @inquiry.address, email: @inquiry.email, interest: @inquiry.interest, name: @inquiry.name, phone: @inquiry.phone, title: @inquiry.title }
    end
  ...
  test "should update inquiry" do
    put :update, id: @inquiry, inquiry: { address: @inquiry.address, email: @inquiry.email, interest: @inquiry.interest, name: @inquiry.name, phone: @inquiry.phone, title: @inquiry.title }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
